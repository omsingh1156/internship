...
color: rgba(0, 159, 0, 0.3);} 
 ...
 #our_courses{position:absolute;left:580px;width:120px;height:70px;top:0px;background-color:#f0f0f0;font-family:"monotype";font-size: 20px;color:white;border-radius:2px 2px 2px 2px ;display: block;   background: linear-gradient( rgba(0,0,0,0.10), rgba(0,0,0,0.10));
    ...
    #our_courses:hover{color:#0099ff; height:75px;width:150px;font-family:"arial narrow";}
     ...
     #mid-box{position:absolute;width:1348px;height:500px;top:100px;background-color:#f0f0f0     }
     #about_us{position:absolute;width:800px;height:380px;top:60px;background-color: ;left:300px;font-family:"rebel" ;font-size:25px;color:#a0a0a0;border-radius:2%;box-shadow: 0px 0px 0.5px 0.5px #5d6675;}
     .legend{font-family: "monotype";font-size:30px;font-weight: bold;color:#5d6675;  }
       #clipboard{position:absolute;left:230px;width:900px;height:450px;top:0px;      }
...
<div id="mid-box">
          <div id="clipboard"> 
             <img src="image/clipboard.jpg" width="900px" height="450px">
           </div>
     <div id="about_us">
	    <legend class="legend"><center>Know About Us</center></legend>
	    <p class="para-about"> 
	    In this digital era, the right data tools have the power to transform businesses by giving them a definitive edge. Powered and promoted by Tech Mahindra,
        ...
        challenge and opportunity, and are committed to educating and empowering professionals through transformational courses.</p>
    </div>
</div>
